...
$string['error:maximalfilenumber_created'] = 'Your comment cannot be created, because it exceeds the maximum number of images. You can add maximal' . get_config('mod_pdfannotator', 'maxfiles') . ' image(s) into comments.';
$string['error:maximalfilenumber_edited'] = 'Your comment cannot be edited, because it exceeds the maximum number of images. You can add maximal' . get_config('mod_pdfannotator', 'maxfiles') . ' image(s) into comments.';
...
$string['maxfiles_help'] = 'Maximal number of file uploaded by users.';
